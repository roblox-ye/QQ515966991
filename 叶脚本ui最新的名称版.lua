...
function library.new(library, name, theme)
    ...
    function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://123097590035361"
        ...
        function tab.section(tab, name, TabVal)
            ...
            SectionOpen.Image = "http://www.roblox.com/asset/?id=123097590035361"
            ...
            SectionOpened.Image = "http://www.roblox.com/asset/?id=123097590035361"
            ...
            function section.Button(section, text, callback)
                ...
                BtnC.CornerRadius = UDim.new(0, 11)
                BtnC.Name = "BtnC"
                BtnC.Parent = Btn
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleBtnC.CornerRadius = UDim.new(0, 11)
                    ...
                    SetState = function(self, state)
                        ...
                        services.TweenService:Create(
                            ...
                            TweenInfo.new(0.2),
                            {
                                ...
                                BackgroundColor3 = (state and Color3.fromRGB(150, 200, 255) or beijingColor)
                            }
                        ):Play()
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderPart.BackgroundColor3 = Color3.fromRGB(150, 200, 255)
